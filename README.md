...
![GitHub last commit](https://img.shields.io/github/last-commit/yourusername/admin-dashboard-repo)
![GitHub stars](https://img.shields.io/github/stars/yourusername/admin-dashboard-repo?style=social)
...
1. **Clone the repository**
   ```bash
   git clone [https://github.com/yourusername/admin-dashboard-repo.git](https://github.com/yourusername/admin-dashboard-repo.git)
